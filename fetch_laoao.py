...
CHANNEL = "douapi"
DATA_FILE = "laoao_data.json"
OFFSET_FILE = ".last_offset_laoao.json"
CLEAN_FLAG_FILE = ".last_clean_date_fetch_laoao"
...
# ========== 彩种正则 ==========
PATTERN = re.compile(r"老澳21\.30第[:\s]*(\d{7})\s*期")
